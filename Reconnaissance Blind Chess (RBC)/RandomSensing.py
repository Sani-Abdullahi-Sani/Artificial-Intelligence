...
class MyAgentPlayer(Player):
    ...
    def choose_sense(self, sense_actions, move_actions, seconds_left):
        ...
        if len(self.potential_states)<1000: #Will picj 500 boards to base the sensing on
        ...
        for potential_move in moves:
            ...
            if move in move_actions:
                ...
                for state in self.potential_states:
                    ...
                    #Check if the invalid move is legal in the state
                    requested_move_legality = chess.Board(state).is_legal(move)
